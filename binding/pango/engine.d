...
const auto PANGO_RENDER_TYPE_NONE = "PangoRenderNone";
...
alias _PangoEngine PangoEngine;
alias _PangoEngineClass PangoEngineClass;
...
const auto PANGO_ENGINE_TYPE_LANG = "PangoEngineLang";
...
alias _PangoEngineLangClass PangoEngineLangClass;
...
const auto PANGO_ENGINE_TYPE_SHAPE = "PangoEngineShape";
...
alias _PangoEngineShapeClass PangoEngineShapeClass;
...
alias _PangoEngineInfo PangoEngineInfo;
alias _PangoEngineScriptInfo PangoEngineScriptInfo;
 ...
 **/
void script_engine_init (GTypeModule *pango_module);
  ...
  const GTypeInfo object_info =						  \
    {									  \
      ...
      NULL           /* value_table */					  \
									  ...
									  \
  prefix ## _type =  g_type_module_register_type (pango_module, parent_type,	  \
						  # name,		  \
						  &object_info, 0);	  \
}+/
