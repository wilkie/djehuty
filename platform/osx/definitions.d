module platform.osx.definitions;
...
const Char[] FontMonospace = "Courier";
const Char[] FontTimes = "Times New Roman";
const Char[] FontSans = "Sans";
const Char[] FontSerif = "Sans Serif";
const Char[] FontSystem = "Sans Serif";
