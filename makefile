...
LFLAGS_LINUX = -Iplatform/unix -L-lX11 -L-lc -L-lm -L-lrt -L-lcairo -L-lpango-1.0 -L-lpangocairo-1.0 -L-lGL -L-llua -L-lncurses -J./tests -L-ltango-user-ldc
...
DFILES_MATH = math/fixed.d math/integer.d math/common.d math/vector.d math/matrix.d math/mathobject.d
