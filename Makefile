...
DFILES_GUI = gui/window.d gui/application.d gui/dialog.d gui/button.d gui/label.d gui/spinner.d gui/progressbar.d gui/scrollbar.d gui/imagebox.d gui/listbox.d
